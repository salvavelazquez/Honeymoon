...
function preload() {
    // Cargar sonidos
    sonidoUno = loadSound("assets/musica/1.mp3");
    sonidoDos = loadSound("assets/musica/2.mp3");
    salto = loadSound("assets/musica/jump.wav");
    win = loadSound("assets/musica/win.mp3");

    // Cargar imágenes
    hadaguia = loadImage("assets/imagenes/HadaGuia.png");
    fondoNivel1 = loadImage("assets/imagenes/FondoPalido.jpg");
    fondoNivel2 = loadImage("assets/imagenes/Fondo2tonos.jpg");
    fondoNivel3 = loadImage("assets/imagenes/FondoFuerte.jpg");
    fondoNivel4 = loadImage("assets/imagenes/FondoInverso.jpg");
    castillo = loadImage("assets/imagenes/castillo.png");
    reina = loadImage("assets/imagenes/reina1.png");
    corona = loadImage("assets/imagenes/corona.png");
    vampiro = loadImage("assets/imagenes/vampirodona.png");

    // Cargar imágenes de nubes y bolas de papel
    imagenNube = loadImage("assets/imagenes/nube.png");
    bolaAmarilla = loadImage("assets/imagenes/bolasdepapel/amarilla.png");
    bolaRosa = loadImage("assets/imagenes/bolasdepapel/rosa.png");
    bolaGris = loadImage("assets/imagenes/bolasdepapel/gris.png");
    bolaVerde = loadImage("assets/imagenes/bolasdepapel/verde.png");

    // Cargar imágenes de enemigos
    donaImagen = loadImage("assets/imagenes/rollut2.png");
    plataformaChocolate = loadImage("assets/imagenes/barra.PNG");
    carameloImagen = loadImage("assets/imagenes/caramelo.png");
    imagenBolaDeFuego = loadImage("assets/imagenes/fire.png");

    // Cargar frames de slime
    for (let i = 0; i < 4; i++) {
        slimeFrames[i] = loadImage(`assets/imagenes/slime/${i + 1}.png`);
    }

    // Cargar frames de zombie
    for (let i = 0; i < 3; i++) {
        zombieFrames[i] = loadImage(`assets/imagenes/zombie/${i + 1}.png`);
    }

    // Cargar imágenes del jugador
    miraDerecha = loadImage("assets/imagenes/jugadora/1.png");
    miraIzquierda = loadImage("assets/imagenes/jugadora/2.png");
    caminaDerecha = loadImage("assets/imagenes/jugadora/3.png");
    caminaIzquierda = loadImage("assets/imagenes/jugadora/4.png");
    alzar = loadImage("assets/imagenes/jugadora/alzar.png");

    // Cargar imágenes de poder
    for (let i = 0; i < 3; i++) {
        secuenciaDePoder[i] = loadImage(`assets/imagenes/jugadora/poder/${i + 1}.png`);
    }
}
